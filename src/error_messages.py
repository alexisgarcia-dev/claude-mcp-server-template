...
class ErrorMessages:
    ...
    API_ERROR: str = "API error (HTTP {status}): {message}. Retry or check server status."
    SEARCH_NO_RESULTS: str = "No results found for '{query}'. Try broader search terms."
    ...
    TASK_NOT_FOUND: str = "Task {task_id} not found. It may have expired or been cancelled."
    ...
    CONFIG_INVALID_URL: str = "Invalid API URL: {url}. Expected format: http(s)://host:port"
